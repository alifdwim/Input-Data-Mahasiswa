...
namespace form_entry_mahasiswa
{
    public partial class Form1 : Form
    {
        ...
        {
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0001", Name = "TAKWAL", Gender = "Laki-laki", Born="Jakarta",Date="12/11/1990",Alamat="Jakarta" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0002", Name = "RENATA", Gender = "Perempuan",Born="JAYAPURA",Date="10/10/1999",Alamat="JAYAPURA" });
        ...
        private void txtNim_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
